        ...
        <ul class="glide__slides">
          <li class="glide__slide">
            ...
            <div class="flex mx-auto my-24 md:flex-row flex-col items-center border-2 border-gray-200 border-opacity-60 rounded-lg">
              ...
              <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-start text-left">
                ...
                <h1 class="title-font text-lg font-medium text-gray-900 mb-3">One</h1>
          ...
          <li class="glide__slide">
            ...
            <div class="flex mx-auto my-24 md:flex-row flex-col items-center border-2 border-gray-200 border-opacity-60 rounded-lg">
              ...
              <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-start text-left">
                <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">CATEGORY</h2>
                <h1 class="title-font text-lg font-medium text-gray-900 mb-3">TWO</h1>
                <p class="leading-relaxed mb-3">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
                <div class="flex items-center flex-wrap ">
                  <a class="text-blue-500 inline-flex items-center md:mb-2 lg:mb-0">Learn More
                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
          ...
          <li class="glide__slide">
            ...
            <div class="flex mx-auto my-24 md:flex-row flex-col items-center border-2 border-gray-200 border-opacity-60 rounded-lg">
              ...
              <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-start text-left">
                <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">CATEGORY</h2>
                <h1 class="title-font text-lg font-medium text-gray-900 mb-3">Three</h1>
                <p class="leading-relaxed mb-3">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
                <div class="flex items-center flex-wrap ">
                  <a class="text-blue-500 inline-flex items-center md:mb-2 lg:mb-0">Learn More
                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
